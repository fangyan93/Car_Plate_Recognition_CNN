...
PLATE_WIDTH_PADDING_FACTOR = 1.05
...
def detectPlatesInScene(imgOriginalScene):
    ...
    for listOfMatchingChars in listOfListsOfMatchingCharsInScene:                   # for each group of matching chars
        ...
        if possiblePlate.imgPlate is not None:                          # if plate was found
            # ww = possiblePlate.rrLocationOfPlateInScene[1][0]
            # hh = possiblePlate.rrLocationOfPlateInScene[1][1]
            # print(ww, hh, (hh/ww))
            # # print((hh / ww) > 0.2 and (ww / hh) < 0.5)
            # if (hh / ww) > 0.2 and (hh / ww) < 0.8:
            #     print("actual ", ww, hh, (hh/ww))
